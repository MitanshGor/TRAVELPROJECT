...
public class PackageDetails 
{
	public static boolean PackageDetailsData(int adminId)
	{
			...
			try
			{
					...
					try
					{
						ticketsAvailable=Integer.parseInt(ch);
					}
					catch(InputMismatchException e)
					{
						IndexClass.CatchBlockStatement();
					...
					int modeOfTrtportation=0;
					ch=sc.next();
					try
					{
						modeOfTrtportation=Integer.parseInt(ch);
					}
					catch(InputMismatchException e)
					{
						IndexClass.CatchBlockStatement();
